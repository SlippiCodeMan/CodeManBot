...
public enum SSBMCharacter {
    ...
    CAPTAIN_FALCON("Captain Falcon", 791703555455189022L, "cptfalcon", "falcon", "falconono", "wizzyfan", "bond", "mrtas"),
    ...
    ZELDA("Zelda", 791703555362258944L, "sheikbutbad", "electrogirl", "magicana"),
    SHEIK("Sheik", 791703555416260638L, "shiek", "techchasemaster"),
    LINK("Link", 791703555450863666L, "biglink"),
    YOUNG_LINK("Young Link", 791703555463053332L, "yl", "young", "ylink", "younglean"),
    PICHU("Pichu", 791703555358195714L, "pikabutbad", "smolpikachu"),
    PIKACHU("Pikachu", 791703555445882920L, "pika", "chu", "pikapika", "yellow rat", "pichuxl"),
