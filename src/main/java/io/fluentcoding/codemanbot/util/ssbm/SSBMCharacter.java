...
public enum SSBMCharacter {
    ...
    BOWSER("Bowser", 791703555517055016L, "bowser", "bowsa", "bowza", "bw", "can't"),
    ...
    FALCO("Falco", 791703555794403338L, "bird", "birdo", "falcolombardi", "kfc"),
    FOX("Fox", 791703556121034762L, "focks", "foxmccloud", "nojohns", "salt", "otah"),
    ...
    ZELDA("Zelda", 791703555362258944L, "badsheik"),
    SHEIK("Sheik", 791703555416260638L, "shiek", "downb"),
